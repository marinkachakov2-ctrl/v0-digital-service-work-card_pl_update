...
// Simple seeded pseudo-random to avoid hydration mismatch from Math.random()
...
function generateMonthData(year: number, month: number): DayData[] {
  ...
  for (let day = 1; day <= daysInMonth; day++) {
    ...
    const reserved = seededRandom(year * 10000 + month * 100 + day) * 45 + 5; // Deterministic between 5-50 hours
