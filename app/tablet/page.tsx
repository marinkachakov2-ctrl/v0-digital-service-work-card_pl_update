...
export default function TabletSystemPage() {
  ...
  const [dispatchDateLabel, setDispatchDateLabel] = useState("");
  ...
  useEffect(() => {
    setDispatchDateLabel(
      new Date().toLocaleDateString("bg-BG", { day: "2-digit", month: "long" })
    );
  }, []);
        ...
        <Card className="bg-[#111] border-gray-800">
          <CardHeader className="flex flex-row items-center justify-between border-b border-gray-800">
            <CardTitle className="text-sm text-gray-400">
              График на техниците - {dispatchDateLabel}
            </CardTitle>
